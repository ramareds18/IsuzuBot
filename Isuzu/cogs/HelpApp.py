...
def log_option(interaction):
    ...
    # em.add_field(name = 'Command options', value = '`status`, `settings`, `channel remove`, `channel deleted`, `channel edited`, `ignore`, `unignore`, `ignored`')
    # command_addition = "`log status` to turn on/off or see the current settings of logging.\n"
    ...
    # command_usage = "log on/off/settings\n"
...
def nodiscussion_option(interaction):
    ...
    # em.add_field(name = 'Command options', value = '`status`, `settings`, `channel`, `ignore`, `unignore`, `ignored`, `remove`')
    # command_addition = "`nodiscussion status` to turn on/off or see the current settings of nodiscussion.\n"
